...
public enum ErrorStatus implements BaseErrorCode {
    ...
    GOOGLE_TOKEN_REQUEST_FAILED(HttpStatus.BAD_REQUEST, "AUTH403", "구글 토큰 요청에 실패했습니다."),
    GOOGLE_USERINFO_REQUEST_FAILED(HttpStatus.BAD_REQUEST, "AUTH404", "구글 유저 정보 요청에 실패했습니다."),
